        ...
        if form.is_valid():
            if form.data['lieu'] == 'mangeoire':
                if mangeoire.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': "Désolé, la mangeoire est occupée"})
                ...
                if roue.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé, la roue est occupée"})            
                elif animal.etat == 'repu' and roue.disponibilite == 'libre':
                    ancien_lieu.disponibilite = "libre"
                    ancien_lieu.save()
                    animal.etat = 'fatigué'
                    form.save()
                    ...
                    if ancien_lieu!= litière:
                        ...
                        ancien_lieu.save()
                        form.save(commit=False)
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé {animal} n'est pas repu"})
                ...
                if litière.disponibilite == 'occupé':
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé, la litière est occupée"})              
                    ...
                    if ancien_lieu!= litière:
                        ...
                        ancien_lieu.save()
                        form.save(commit=False)
                    return render(request ,"blog/animal_detail.html", {'animal': animal, 'message': f"Désolé {animal} n'est pas endormi"})
